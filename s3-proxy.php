<?php
// s3-proxy.php - Proxy Inteligente con Verificación Estricta de Membresía y Dominio
...
// --- SEGURIDAD ESTRICTA: CONTROL DE DOMINIOS (HOTLINK) ---
...
// Bloqueo total si el origen de la petición está en blanco (Referer vacío)
...
// Si $isAllowed es FALSE, se cierra la conexión de golpe, ahorrando ancho de banda.
if (!$isAllowed) { header('HTTP/1.1 403 Forbidden'); exit('Access Denied: Hotlink Protection Active'); }
...
if (!$storage && in_array($video['storage_type'], ['wasabi','contabo','aws','cloudflare','backblaze'])) {
