<?php
// Determinamos el prefijo de la URL dependiendo de si es Admin o Usuario normal
$isUserAdmin = isAdmin();
$dashPrefix = $isUserAdmin ? '/admin' : '/users';
?>
...
<div class="sidebar" id="main-sidebar">
    ...
    <nav>
        <ul class="nav-menu">
            <li class="nav-item">
                <a href="<?= $dashPrefix ?>" class="nav-link">
            ...
            <li class="nav-item">
                <a href="<?= $dashPrefix ?>/videos" class="nav-link">
            ...
            <li class="nav-item">
                <a href="<?= $dashPrefix ?>/domains" class="nav-link">
            ...
            <li class="nav-item">
                <a href="/mes_gratis" class="nav-link" style="color: var(--accent-green);">
            ...
            <li class="nav-section">
                ...
                <li class="nav-item">
                    <a href="/admin/storage" class="nav-link">
                ...
                <li class="nav-item">
                    <a href="/admin/payment_settings" class="nav-link">
