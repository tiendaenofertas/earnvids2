...
<head>
    ...
    <style>
        ...
        .search-box input { width: 100%; padding: 10px 15px 10px 40px; background: var(--bg-primary); border: 1px solid var(--border-color); border-radius: 6px; color: #fff; outline: none; }
        .search-box input:focus { border-color: var(--accent-green); }
        .search-box svg { position: absolute; left: 12px; top: 10px; color: #888; }
    </style>
</head>
<body>
        ...
        <div class="toolbar">
            <div style="display: flex; gap: 15px; flex-wrap: wrap;">
                <div class="search-box">
                    ...
                    <input type="text" id="searchInput" placeholder="Buscar transacción o usuario...">
                </div>
            ...
            <form method="POST" onsubmit="return confirm('¿Estás seguro? Se eliminarán los registros en estado \'Waiting\' que tengan más de 48 horas de antigüedad.');">
