<?php
// admin/users.php - Gestión de Usuarios con Control de Membresía
...
// Consultar usuarios incluyendo fecha de expiración
$stmt = db()->prepare("
    SELECT u.*, 
...
<head>
    ...
    <style>
        ...
        .membership-control { display: flex; align-items: center; gap: 8px; background: rgba(0,0,0,0.2); padding: 5px; border-radius: 6px; border: 1px solid var(--border-color); width: fit-content; }
        .days-input { width: 50px; background: var(--bg-primary); border: 1px solid var(--border-color); color: #fff; padding: 5px; border-radius: 4px; text-align: center; font-size: 13px; }
        .days-input:focus { outline: none; border-color: var(--accent-green); }
...
<body>
            ...
            <table>
                <thead>
                    <tr>
                        ...
                        <th>Membresía (Días)</th> <th>Estado</th>
                        <th>Acciones</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr id="row-<?= $user['id'] ?>">
                        ...
                        <td>
                            ...
                            <div class="membership-control">
                                <input type="number" id="input-days-<?= $user['id'] ?>" class="days-input" placeholder="Días" value="30" min="1">
    ...
    <script>
        ...
        // Función existente para suspender usuarios (se mantiene)
