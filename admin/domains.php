<?php
// admin/domains.php - Gestión de Dominios Permitidos por Usuario
...
// 1. Obtener Límite y Uso actual
$stmt = db()->prepare("SELECT domain_limit FROM users WHERE id = ?");
$stmt->execute([$userId]);
$userLimit = $stmt->fetchColumn();
$limit = ($userLimit !== false) ? intval($userLimit) : 3; // Default 3 si es null
...
$percent = ($limit > 0) ? min(100, round(($count / $limit) * 100)) : 100;
?>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <style>
        ...
        .domain-url { font-family: monospace; font-size: 1.1em; color: var(--text-primary); }
...
<body>
        ...
        <div class="domains-container">
            ...
            <div class="limit-card">
                <div class="limit-header">
                    ...
                    <span class="limit-value"><?= $count ?> / <?= $limit ?></span>
                </div>
            ...
            <div class="domain-list">
                <?php if ($count > 0): ?>
                    ...
                    <div class="domain-item" id="domain-row-<?= $domain['id'] ?>">
                        <div>
                            <div class="domain-url"><?= htmlspecialchars($domain['domain']) ?></div>
    ...
    <script>
        ...
        function deleteDomain(id) {
            ...
            .then(data => {
                if(data.success) {
                    document.getElementById('domain-row-' + id).style.opacity = '0.5';
