<?php
// login.php - Login blindado con soporte para Rate Limiting
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!isset($_POST['csrf_token']) || $_POST['csrf_token'] !== $_SESSION['csrf_token']) {
        ...
        try {
            ...
            // AQUÍ ESTÁ EL CAMBIO: Muestra el mensaje exacto de bloqueo por 15 minutos
            $error = $e->getMessage();
        ...
        <div class="login-box">
            <div class="login-logo">
                <a href="/" class="logo" style="text-decoration: none;">
                    ...
                    <h1 style="font-size: 24px; margin-top: 10px; color:#fff;">XVIDS<span>PRO</span></h1>
                </a>
            </div>
            ...
            <p style="text-align: center; margin-top: 20px; color: var(--text-secondary);">
                ¿No tienes cuenta? <a href="/register" style="color: var(--accent-green);">Regístrate</a>
            </p>
        </div>
    </div>
</body>
