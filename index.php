<?php
// index.php - Landing Page Completa (Planes, Testimonios, Multi-idioma, Fallback de Estadísticas)
...
try {
    // 1. Intenta leer de la caché rápida
...
// 2. AUTO-RESCATE: Si los datos siguen siendo 0, cuenta en tiempo real desde la Base de Datos
...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .lang-switch { display: inline-flex; background: rgba(255,255,255,0.1); border-radius: 30px; padding: 4px; align-items: center; margin-right: 10px; }
        ...
        .section-header p { font-size: 18px; color: rgba(255, 255, 255, 0.7); max-width: 700px; margin: 0 auto; }
        ...
        /* Testimonios (Ahora con 6 tarjetas) */
        ...
        /* Modificación del Footer Bottom (Logo y Copyright) */
        ...
        @media (max-width: 900px) { 
            ...
            .nav-buttons span, .nav-buttons .btn { display: none; }
            ...
            <div class="hero-content">
                <div class="hero-text">
                    ...
                    <div class="hero-buttons">
                        ...
                        <a href="/register.php" class="btn btn-secondary"><?= __('btn_account') ?></a>
                    </div>
                </div>
            ...
            <div class="testi-grid">
                ...
                <div class="testi-card">
                    ...
                    <div class="user-profile">
                        ...
                        <div class="user-info-text">
                            <h5>Ana Torres</h5>
                            <span>Directora de E-commerce</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="testi-card">
                    ...
                    <div class="user-profile">
                        ...
                        <div class="user-info-text">
                            <h5>Elena Castro</h5>
                            <span>Directora de Agencia Digital</span>
                        </div>
                    </div>
                </div>
            </div>
