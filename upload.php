...
// Lógica de Permisos de Almacenamiento
$isAdmin = isset($_SESSION['role']) && $_SESSION['role'] === 'admin';
$userHasStorage = 'true'; // Por defecto permitido (para admins y fallbacks)

if (!$isAdmin) {
    // Solo si NO es admin, verificamos si tiene configuración propia obligatoria
    $stmt = db()->prepare("
        SELECT id 
        FROM storage_config 
        WHERE user_id = ? 
...
<head>
    ...
    <style>
        ...
        /* Estilo visual para usuarios bloqueados */
