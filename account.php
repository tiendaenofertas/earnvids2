...
if (isset($_GET['payment'])) {
    if ($_GET['payment'] === 'success') {
        $message = "¡Pago iniciado! Tu membresía se activará en cuanto la red confirme la transacción (puede tardar unos minutos).";
        $messageType = "success";
...
<head>
    ...
    <style>
        ...
        /* Estilos de Planes (Diseño idéntico al original) */
...
<body>
            ...
            <div class="account-section">
                ...
                <div class="pricing-grid">
                    ...
                    <div class="price-card <?= $isPop ? 'featured' : '' ?>">
                        ...
                        <button class="btn-plan" onclick="purchasePlan(<?= $plan['id'] ?>, this)">
                            ELEGIR PLAN
                        </button>
                    </div>
                    <?php endforeach; ?>
            ...
            <div class="account-section">
                ...
                <div style="margin-top: 20px; border-top: 1px solid var(--border-color); padding-top: 20px;">
                    ...
                    <p style="font-size: 0.9em; color: var(--text-secondary); margin-bottom: 15px;">
                        Configura tu almacenamiento (Wasabi, Contabo, AWS). El sistema verificará la conexión antes de guardar.
                    </p>
                    <form method="POST">
                        ...
                        <div style="display:grid; grid-template-columns: 1fr 1fr; gap:15px;">
                            ...
                            <div>
                                <label>Región</label>
                                <input type="text" name="region" class="form-control" placeholder="Ej: us-east-1" required>
                            </div>
                        </div>
                        
                        <label>Endpoint URL</label>
                        <input type="text" name="endpoint" class="form-control" id="endp" placeholder="https://..." required>
    ...
    <script>
        // --- MOTOR DE PAGOS (AJAX) ---
        // Esta función se comunica con api/create_payment.php sin recargar la página
        async function purchasePlan(planId, btn) {
            ...
            try {
                ...
                // Intentar leer la respuesta, sea JSON o texto de error
        ...
        // --- Ayuda Visual para Endpoints de Almacenamiento ---
        const prov = document.getElementById('prov');
        const endp = document.getElementById('endp');
        if(prov && endp) {
            prov.addEventListener('change', function() {
                const val = this.value;
                if(val==='wasabi') endp.placeholder='https://s3.wasabisys.com';
                if(val==='contabo') endp.placeholder='https://eu2.contabostorage.com';
                if(val==='aws') endp.placeholder='https://s3.amazonaws.com';
            });
        }
    </script>
</body>
